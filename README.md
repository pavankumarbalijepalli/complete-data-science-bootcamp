...
|                                                               Stage                                                                      | Expected Time | Date of completion |  Status | Done by|
|------------------------------------------------------------------------------------------------------------------------------------------|---------------|--------------------|:-------:|-------|
| __Phase 0__                                                                                                                              |               |                    | 🌑      | Pavan |
...
| __Phase 4__                                                                                                                              |               |                    | 🌑      | Pavan |
| * Text2Image - HuggingFace Transformer Models, Making inference from LLMs, Fine tuning LLMs with custom dataset                          |               |                    | 🌑      | Pavan |
| * Text2Video - HuggingFace Transformer Models, Making inference from LLMs, Fine tuning LLMs with custom dataset                          |               |                    | 🌑      | Pavan |
...
| * IDK - What else is new here?                                                                                                           |               |                    | 🌑      | Pavan |
| __Phase X__                                                                                                                              |               |                    | 🌑      | Pavan |
